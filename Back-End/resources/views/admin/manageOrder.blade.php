...
<ul class="breadcrumb">
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					...
					@foreach( $allOrderInfo as $vOrder )
						  ...
						  <tbody>
							<tr>
                                ...
                                <td class="center">{{$vOrder->order_status}}</td>
								...
								<td class="center">
										...
										<a class="btn btn-danger" href="{{URL::to('/inactive/'.$vOrder->order_id)}}">
									...
									<a class="btn btn-info" href="{{URL::to('/edit/'.$vOrder->order_id)}}">
